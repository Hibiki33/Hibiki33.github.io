...
$$ P(H\|A) = P(H)\frac{P(A\|H)}{P(A\|H)P(H)+P(A\|\bar{H})P(\bar{H}c)} $$
...
1. $$P(H\|A_1) \approx 1 \and \frac{P(A_2\|\bar{H})}{P(A_2\|H)}\neq \infty$$，即$$P(H\|A_1) \approx P(H\|A_1,A_2) \approx 1$$
    - $$A_1$$是支持$$H$$的排他性证据
    - $$A_2$$不是反对$$H$$​的排他性证据
2. $$P(H\|A_1) \approx 0 \and \frac{P(A_2\|\bar{H})}{P(A_2\|H)}\neq 0$$，即$$P(H\|A_1) \approx P(H\|A_1,A_2) \approx 0$$
    - $$A_1$$是反对$$H$$的排他性证据
    - $$A_2$$不是支持$$H$$的排他性证据
...
- $$A' = A_1 \and A_2$$，可以认为$$A'$$的粒度比$$A_1$$更细，例如北京人且在985大学上学是比北京人更细的观测
